...
static esp_err_t estop_on_handler(httpd_req_t *req)
{
...
static esp_err_t estop_off_handler(httpd_req_t *req)
{
...
static esp_err_t estop_status_handler(httpd_req_t *req)
{
...
static esp_err_t control_handler(httpd_req_t *req)
{
    ...
    "<p>Press SPACEBAR to toggle E-STOP</p>"
...
httpd_uri_t estop_on_uri = {
    .uri = "/estop_on",
    .method = HTTP_GET,
    .handler = estop_on_handler,
    .user_ctx = NULL
};

httpd_uri_t estop_off_uri = {
    .uri = "/estop_off",
    .method = HTTP_GET,
    .handler = estop_off_handler,
    .user_ctx = NULL
};

httpd_uri_t estop_status_uri = {
    .uri = "/status",
    .method = HTTP_GET,
    .handler = estop_status_handler,
    .user_ctx = NULL
};
...
void startCameraServer() {
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &estop_status_uri);
    ...
    httpd_register_uri_handler(camera_httpd, &estop_on_uri);
    httpd_register_uri_handler(camera_httpd, &estop_off_uri);
    httpd_register_uri_handler(camera_httpd, &estop_status_uri);
  }
